...
<body style="background-image: url(../images/76ba31b9-b382-4ae8-929e-3327c7267c94.jpg); background-repeat: repeat; background-size: cover">
    ...
    <form style="display: inline;" runat="server" method="post">
        <div id="page">
            ...
            <div class="col-md-8" style="background: rgba(0,0,0,.5); margin-left: 10%; position: relative; width: 80%; height: 70%; border-radius: 0.35em; /* box-shadow: 0 3px 10px 0 rgba(0, 0, 0, 0.2); */
            text-align: center;">
                ...
                <asp:GridView ID="requestsGrid" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="approveBtn" runat="server" OnClick="approveBtn_Click" CausesValidation="false" CommandName="Select" CssClass="login100-form-btn" Text="approve"></asp:LinkButton>
                                <asp:LinkButton ID="rejectBtn" runat="server" OnClick="rejectBtn_Click" CausesValidation="false" CommandName="Select" CssClass="login100-form-btn" Text="reject"></asp:LinkButton>
